...
int main () {
    ...
    {
    bigint left("1234567890123456789012345678901234567890123456789012345678901234567890");
    bigint right(10);
    bigint result= left + right;
    std:: cout << left << " + " << right<< " = " << result <<std::endl;
    assert(left   == "1234567890123456789012345678901234567890123456789012345678901234567890");
    assert(right  == 10);
    assert(result == "1234567890123456789012345678901234567890123456789012345678901234567900");
    }
